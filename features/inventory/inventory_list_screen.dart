...
class _InventoryListScreenState extends State<InventoryListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(t.itemList)),
      body: Stack(
        children: [
          Column(
            children: [
              ...
              Expanded(
                child: _loading
                    ...
                    : _items.isEmpty
                        ? Center(
                            child: Text(t.inventoryEmptyMessage,
          ...
          children: [
            ...
            if (item.isLowStock)
              Container(
                ...
                child: Text(t.lowStockBadge, style: AppFonts.body(fontSize: 10, color: AppColors.danger, weight: FontWeight.w700)),
              ),
