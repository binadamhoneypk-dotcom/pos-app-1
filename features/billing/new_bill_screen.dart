...
class _NewBillScreenState extends State<NewBillScreen> {
  ...
  Future<void> _saveBill() async {
    if (_lines.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(t.billNeedsItemMessage)));
      return;
    }
    final business = context.read<AppState>().currentBusiness;
    if (business == null) return;
  ...
  Widget build(BuildContext context) {
    final t = AppLocalizations.of(context)!;
    return Scaffold(
      appBar: AppBar(title: Text(t.newBillTitle)),
      body: Stack(
        children: [
          ListView(
            padding: const EdgeInsets.fromLTRB(16, 16, 16, 90),
            children: [
              Text(t.customerNameOptionalLabel, style: AppFonts.body(fontSize: 12.5, color: AppColors.inkSoft)),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(_customer?.name ?? t.walkInCustomerTapToChangeLabel),
                      ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(t.totalAmountLabel, style: AppFonts.body(fontSize: 13, color: Colors.white70)),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: t.receivedAmountLabel,
  ...
  Widget _dueBanner(Customer customer) {
    ...
    final label = owesUs
        ? t.oldDueOwedToYouLabel(AppFormat.currency(customer.currentBalance))
        : t.oldDueYouOweLabel(AppFormat.currency(customer.currentBalance.abs()));
    return Container(
      width: double.infinity,
