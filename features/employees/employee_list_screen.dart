...
class _EmployeeListScreenState extends State<EmployeeListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(t.employeeLedgerTitle)),
          ...
          : RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(child: _summaryTile(t.owedToEmployeesLabel, owed, AppColors.danger)),
                      const SizedBox(width: 12),
                      Expanded(child: _summaryTile(t.owedByEmployeesLabel, advances, AppColors.success)),
                    ],
                  ),
                  ...
                  if (_employees.isEmpty)
                    Padding(
                      ...
                      child: Center(
                        child: Text(t.noEmployeesYetMessage,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    [if (e.roleTitle != null) e.roleTitle!, t.salaryLabel(AppFormat.currency(e.monthlySalary))].join(' • '),
            ...
            Text(
              e.currentBalance == 0 ? t.settled : AppFormat.currency(e.currentBalance.abs()),
